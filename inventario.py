...
class Inventario(tk.Frame):
    ...
    def widgets(self):
#=====================================================================================================================
            canvas_articulos = tk.LabelFrame(self, text="Articulos", font="arial 14 bold", bg= "#87CEEB")
            canvas_articulos.place(x=300, y=10, width=780, height=580)
            
            self.canvas = tk.Canvas(canvas_articulos, bg="#87CEEB")
            self.scrollbar = tk.Scrollbar(canvas_articulos, orient="vertical", command=self.canvas.yview) #PARA QUE SE PUEDA DESPLAZAR VERTICALMENTE COMO LA BARRA
...
#=====================================================================================================================
            lblframe_buscar = LabelFrame(self, text= "Buscar", font="arial 14 bold", bg="#87CEEB")
...
#=====================================================================================================================
            ...
            lblframe_seleccion = LabelFrame(self, text="Selección", font="arial 16 bold", bg="#87CEEB")
            lblframe_seleccion.place(x=10, y=100, width=280, height=190)
            
            self.label1 = tk.Label(lblframe_seleccion, text="Articulos: ", font="arial 12 bold ", bg="#87CEEB", wraplength=300)
            self.label1.place(x=5, y=5)
            
            self.label2 = tk.Label(lblframe_seleccion, text="Precios: ", font="arial 12 bold", bg="#87CEEB", wraplength=300)
            self.label2.place(x=5, y=40)
            
            self.label3 = tk.Label(lblframe_seleccion, text="Costo: ", font="arial 12 bold", bg="#87CEEB", wraplength=300)
            self.label3.place(x=5, y=70)
            
            self.label4 = tk.Label(lblframe_seleccion, text="Stock: ", font="arial 12 bold", bg="#87CEEB", wraplength=300)
            self.label4.place(x=5, y=100)
            
            self.label5 = tk.Label(lblframe_seleccion, text="Estado: ", font="arial 12 bold", bg="#87CEEB", wraplength=300)
            self.label5.place(x=5, y=130)
#=====================================================================================================================            
            
            lblframe_botones = LabelFrame(self, bg="#87CEEB", text= "Opciones", font= "Arial 14 bold")
    ...
    def agregar_articulo(self):
        ...
        tk.Label (top, text="Articulo: ", font= "arial 12 bold", bg="#87CEEB",anchor="w").place(x=20, y=20, width=80 ,height=25)   #DIMENSION DE LABEL "ARTICULO"
        entry_articulo = ttk.Entry(top, font="arial 12 bold" )
        entry_articulo.place(x=120, y=18, width=250, height=30)   # DIMENSAIONES DE LA CAJA DEL ENTRY
        
        tk.Label (top, text="Precio: ", font= "arial 12 bold", bg="#87CEEB",anchor="w").place(x=20, y=60, width=80 ,height=25)   #DIMENSION DE LABEL "ARTICULO"
        entry_precio = ttk.Entry(top, font="arial 12 bold" )
        entry_precio.place(x=120, y=58, width=250, height=30) 
        
        tk.Label (top, text="Costo: ", font= "arial 12 bold", bg="#87CEEB",anchor="w").place(x=20, y=100, width=80 ,height=25)   #DIMENSION DE LABEL "ARTICULO"
        entry_costo = ttk.Entry(top, font="arial 12 bold" )
        entry_costo.place(x=120, y=98, width=250, height=30) 
        
        tk.Label (top, text="Stock: ", font= "arial 12 bold", bg="#87CEEB",anchor="w").place(x=20, y=140, width=80 ,height=25)   #DIMENSION DE LABEL "ARTICULO"
        entry_stock = ttk.Entry(top, font="arial 12 bold" )
        entry_stock.place(x=120, y=138, width=250, height=30) 
        
        tk.Label (top, text="Estado: ", font= "arial 12 bold", bg="#87CEEB",anchor="w").place(x=20, y=180, width=80 ,height=25)   #DIMENSION DE LABEL "ARTICULO"
        entry_estado = ttk.Entry(top, font="arial 12 bold" )
        entry_estado.place(x=120, y=178, width=250, height=30) 
        ...
        def guardar():
            ...
            if not articulo or not precio or not costo or not stock or not estado:
                messagebox.showerror("Error", "Todos los campos deben ser completador")
                return
            ...
            try:
                ...
                messagebox.showerror("Error", "precio, costo y stock deben ser numero validos")
            ...
            try:
                ...
                self.cargar_articulos()      #cargar los articulos y los muestra de inmediato en el inventario
                self.articulos_combobox()
        ...
        tk.Button(top, text="Guardar", font="arial 12 bold", command=guardar).place(x=50, y=260, width=150, height=40)              #boton de guardar
        tk.Button(top, text="Cancelar", font="arial 12 bold", command=top.destroy).place(x=260, y=260, width=150, height=40)        #boton de eliminar
    ...
    def mostrar_articulo(self, articulo, precio, image_path):
        ...
        precio_label = tk.Label(
            article_frame,
            text= f"Precio: S/{precio:.2f}",
            bg="white",
            wraplength=150,
            anchor="w",
            font="arial 8 bold")
        
        precio_label.pack(side="bottom", fill="x", pady=5)
    ...
    def editar_articulo(self):
        ...
        tk.Label(top, text="Articulo: ", font="arial 12 bold", bg="#87CEEB").place(x=20, y=20, width=80, height=25)
        entry_articulo = ttk.Entry(top, font="arial 12 bold")
        entry_articulo.place(x=120, y=20, width=250, height=30)
        entry_articulo.insert(0, articulo)
        
        tk.Label(top, text="Precio: ", font="arial 12 bold", bg="#87CEEB").place(x=20, y=60, width=80, height=25)
        entry_precio = ttk.Entry(top, font="arial 12 bold")
        entry_precio.place(x=120, y=60, width=250, height=30)
        entry_precio.insert(0, precio)
        
        tk.Label(top, text="Costo: ", font="arial 12 bold", bg="#87CEEB").place(x=20, y=100, width=80, height=25)
        entry_costo = ttk.Entry(top, font="arial 12 bold")
        entry_costo.place(x=120, y=100, width=250, height=30)
        entry_costo.insert(0, costo)
        
        tk.Label(top, text="Stock: ", font="arial 12 bold", bg="#87CEEB").place(x=20, y=140, width=80, height=25)
        entry_stock = ttk.Entry(top, font="arial 12 bold")
        entry_stock.place(x=120, y=140, width=250, height=30)
        entry_stock.insert(0, stock)
        
        tk.Label(top, text="Estado: ", font="arial 12 bold", bg="#87CEEB").place(x=20, y=180, width=80, height=25)
        entry_estado= ttk.Entry(top, font="arial 12 bold")
        ...
        def guardar():
            ...
            if not nuevo_articulo or not precio or not costo or not stock or not estado:    #aqui configuramos que si no esta nunguno de los articulos no deja realizar cambios
                messagebox.showerror("Erro", "Todos los campos deben ser completador")
                return
            ...
            self.cur.execute("UPDATE articulos SET articulo=?, precio=?, costo=?, stock=?, estado=? WHERE articulo=?",
                            (nuevo_articulo, precio, costo, stock, estado, selected_item,))
            self.con.commit()
