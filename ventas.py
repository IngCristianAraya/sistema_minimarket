...
class Ventas(Frame):
    ...
    def ver_ventas_realizadas(self):
        try:
            ...
            tre_frame = tk.Frame(ventana_ventas, bg="white")  
            tre_frame.place(x=20,y=130,width=1060,height=500)  
    ...
    #frame_ventas = tk.Frame(ventana_ventas, bg="white")
    #frame_ventas.pack(fill="both", expand=True, padx=10, pady=10)

            # Scrollbars
            scroll_y = ttk.Scrollbar(tre_frame, orient=VERTICAL)
            ...
            tree = ttk.Treeview(tre_frame, columns=("Factura", "Cliente", "Producto", "Precio", "Cantidad", "Total","Fecha","Hora"), show="headings")
